...
class TestBooksCollector:
    ...
    def test_add_new_book_one_amount_book_added(books_collector):
...
#тест на успешное добавление книги в словарь
    ...
    def test_set_book_genre_one_book_book_added(books_collector):
...
#тест на успешное присвоение жанра новой книги
    ...
    def test_get_book_genre_with_valid_genre(books_collector):
...
#тест на вывод книг с определенным жанром
    ...
    def test_get_book_genre_for_existing_book(books_collector):
...
#тест на вывод жанра книги по ее имени
    ...
    def test_get_books_genre_returns_dictionary(books_collector):
...
#тест на вывод текущего словаря
    ...
    def test_get_books_for_children_only(books_collector):
...
#тест на возвращение детских книг
    ...
    def test_add_book_in_favorites_book_added(books_collector):
...
#тест на добавление книги в избранное
    ...
    def test_get_list_of_favorites_books_empty(books_collector):
        ...
        books_collector.add_book_in_vaforites('Книга 3')

        favorites = list(books_collector.get_list_of_favorites_books())

        assert 'Книга 1' and 'Книга 3' in favorites
